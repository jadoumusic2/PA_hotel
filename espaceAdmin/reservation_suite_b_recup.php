...
if(isset($_POST['modify_id'])) {
    ...
    $sql = $conn->prepare("SELECT arrival_days, depart_days, number, phone_number, name, email FROM suites_b WHERE id = ?");
...
<head>
    ...
    <title>Espace Admin - Modification suite b</title>
    <style>
        .centre {
            text-align: center;
        }
...
<body>
    ...
    <div class="centre">
    <h2>Modifier information suite b :</h2>
    <form method="post" action="reservation_suite_b_traitement.php">
