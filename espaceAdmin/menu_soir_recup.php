...
if(isset($_POST['modify_id'])) {
    ...
    $sql = $conn->prepare("SELECT date, entre, plat, fromage, dessert, prix_menu FROM menu_soir WHERE id = ?");
...
<head>
    ...
    <title>Espace Admin - Modifier le menu du soir</title>
    <style>
        .centre {
            text-align: center;
        }
...
<body>
    ...
    <form method="post" action="menu_soir_traitement.php">
