...
if(isset($_POST['modify_id'])) {
    ...
    $sql = $conn->prepare("SELECT arrival_days, depart_days, number, phone_number, name, email FROM chambre_familial WHERE id = ?");
...
<head>
    ...
    <title>Espace Admin - Modification chambre familial</title>
    <style>
        .centre {
            text-align: center;
        }
...
<body>
    ...
    <div class="centre">
    <h2>Modifier information chambre familial :</h2>
    <form method="post" action="reservation_chambre_familial_traitement.php">
